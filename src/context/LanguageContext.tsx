...
const faTranslations: Translations = {
  ...
  news_view_wire: 'نمای تیکر سریع',
  news_view_grid: 'نمای کارت‌های تحلیلی',
  news_view_split: 'نمای اسپلیت ریدر',
  news_saved: 'نشان‌شده‌ها',
  news_save_article: 'نشان کردن مقاله',
  news_remove_saved: 'حذف از نشان‌ها',
  news_sentiment_distribution: 'توزیع تمایلات فید خبری',
  news_avg_sentiment: 'میانگین تمایل FinBERT',
  news_dominant_narrative: 'روایت‌ها و تم‌های بازار',
  news_sort_latest: 'تازه‌ترین اخبار',
  news_sort_bullish: 'بیشترین سیگنال صعودی',
  news_sort_bearish: 'بیشترین سیگنال نزولی',
  news_sort_impact: 'بالاترین اثر بر بازار',
  ...
  social_view_stream: 'جریان زنده چت',
  social_view_cards: 'کارت‌های آلفا',
  social_view_desks: 'میزهای معاملاتی رسمی',
  social_sentiment_ratio: 'نسبت صعودی به نزولی',
  social_velocity: 'سرعت و حجم گفتگوها',
  social_trending_topics: 'برچسب‌های داغ بازار',
  social_upvote: 'تایید',
  social_copy: 'کپی دیدگاه',
  copied_to_clipboard: 'در کلیپ‌بورد کپی شد!',
  market_impact_high: 'اثر بالا بر بازار',
  market_impact_med: 'اثر متوسط',
  market_impact_low: 'عادی',
...
const enTranslations: Translations = {
  ...
  news_view_wire: 'Wire Feed',
  news_view_grid: 'Card Grid',
  news_view_split: 'Split Reader',
  news_saved: 'Bookmarks',
  news_save_article: 'Bookmark story',
  news_remove_saved: 'Remove bookmark',
  news_sentiment_distribution: 'Sentiment Breakdown',
  news_avg_sentiment: 'Avg FinBERT Sentiment',
  news_dominant_narrative: 'Dominant Narratives',
  news_sort_latest: 'Latest First',
  news_sort_bullish: 'Most Bullish',
  news_sort_bearish: 'Most Bearish',
  news_sort_impact: 'Highest Market Impact',
  ...
  social_view_stream: 'Live Stream',
  social_view_cards: 'Alpha Cards',
  social_view_desks: 'Desk Focus',
  social_sentiment_ratio: 'Bull/Bear Ratio',
  social_velocity: 'Discussion Velocity',
  social_trending_topics: 'Trending Topics',
  social_upvote: 'Upvote',
  social_copy: 'Copy Quote',
  copied_to_clipboard: 'Copied to clipboard!',
  market_impact_high: 'High Market Impact',
  market_impact_med: 'Medium Impact',
  market_impact_low: 'Standard Item',
