...
export const AlertsView: React.FC = () => {
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    ...
    setStatusMessage(`Alert subscription activated for ${assetSymbol}! Automated bulletins will dispatch to ${email}.`);
    setTimeout(() => setStatusMessage(null), 4000);
  };

  const handleTestDispatch = async (id: string) => {
    const msg = await simulateDispatchAlert(id);
  ...
  return (
    <div id="alerts-and-newsletter-view" className="space-y-4 p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Set automated notifications for price swings, high-impact catalysts, and pre-market morning briefings.
            </p>
          </div>
        </div>
      ...
      {statusMessage && (
        <div className="p-3 bg-emerald-950/60 border border-emerald-600/60 rounded-xl text-xs text-emerald-300 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        {/* Subscription Form */}
        <div className="lg:col-span-5 bg-[#07111e] p-4 rounded-xl border border-slate-800 space-y-3.5">
          ...
          <form onSubmit={handleSubscribe} className="space-y-3 text-xs">
            ...
            >
              ...
              <span>Register Alert Subscription</span>
            </button>
          </form>
        </div>
        ...
        <div className="lg:col-span-7 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] text-slate-400">
              Dispatched automatically via web hooks
            </span>
          </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      onClick={() => handleTestDispatch(a.id)}
