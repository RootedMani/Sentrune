        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1.5 max-w-2xl">
            ...
            <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
              {language === 'fa'
                ? 'ارزیابی همزمان بازار توسط مدل‌های پیشرفته GPT OSS 120B، Qwen 3.8 27B، GPT OSS 20B روی پردازنده‌های LPU شرکت Groq و Google Gemini Flash همراه با استخراج سیگنال‌های کمّی.'
                : 'Live multi-model inference benchmarking across OpenAI GPT OSS 120B, Qwen 3.8 27B, GPT OSS 20B on Groq LPUs alongside Google Gemini Flash and quantitative ensembles.'}
            </p>
          </div>
