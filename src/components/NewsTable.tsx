...
export const NewsTable: React.FC = () => {
  ...
  // Retrieve news instantly from L1/L2 cache (0ms latency)
  ...
  return (
    <div id="financial-news-view" className="space-y-3 p-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-white dark:bg-[#081322] p-3 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
        <div className="flex items-center gap-2.5 flex-1 flex-wrap">
          ...
          <div className="relative flex-1 min-w-[200px] max-w-md">
            ...
            <input
              ...
              className="w-full bg-slate-50 dark:bg-[#050c17] border border-slate-200 dark:border-slate-700/80 rounded-lg pl-9 pr-3 py-1.5 text-xs text-slate-800 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:border-cyan-500"
            />
          </div>
        ...
        <div className="flex items-center gap-2.5 self-end md:self-center">
          {/* Cache Status Badge */}
          <div className="flex items-center gap-1.5 text-[11px] bg-slate-50 dark:bg-[#050c17] border border-slate-200 dark:border-slate-800 px-2.5 py-1 rounded-md text-slate-600 dark:text-slate-400">
            <Database className="w-3 h-3 text-cyan-500" />
            <span>Cache: <strong className="text-emerald-600 dark:text-emerald-400 font-normal">Instant ({cachedData.meta.latencyMs}ms)</strong></span>
          </div>
      ...
      <div className="bg-white dark:bg-[#07111e] rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm transition-colors">
        ...
        {isDemo && hiddenCount > 0 && (
          <div className="p-4 bg-slate-50 dark:bg-gradient-to-r dark:from-[#09182b] dark:to-[#0d2038] border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-3 text-left">
              <div className="w-9 h-9 rounded-lg bg-amber-100 dark:bg-amber-500/20 border border-amber-300 dark:border-amber-500/40 flex items-center justify-center text-amber-700 dark:text-amber-400 flex-shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white text-xs font-bold rounded-lg shadow-md transition-all cursor-pointer whitespace-nowrap"
            >
